	...
	public function get_order_data($order_id) {
		$this->db
			->select('sl.id, sl.fecha, sl.id_solicitante, us.nombre AS nombre_cliente, us.apellido AS apellido_cliente, sl.fecha_recogida, ' .
				...
				'sl.id_reciclatendero, us2.nombre AS nombre_recicla_tendero, us2.apellido AS apellido_recicla_tendero, us2.foto,us2.placa, us.telefono AS telefono_empleado, ' .
